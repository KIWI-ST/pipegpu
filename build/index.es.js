...
var e = 1, t = () => e++, n = (...e) => e.reduce((e, t) => e > t ? e : t), r = (...e) => e.reduce((e, t) => e < t ? e : t), i = (...e) => {
	...
	label;
	constructor(e) {
		if (this.id = e.id, this.context = e.context, this.label = e.label, this.bufferUsageFlags = e.bufferUsageFlags | GPUBufferUsage.COPY_SRC, this.totalByteLength = this.latestTotalByteLength = e.totalByteLength, !this.totalByteLength) throw Error("[E][BaseBuffer][constructor] create buffer error, opts.totalByteLength value invalid.");
	}
	getID = () => this.id;
	...
	updateGpuBuffer = (e, t, n) => {
		if (e + t > this.totalByteLength || n.byteLength > this.totalByteLength) throw Error(`[E][VertexBuffer][updateGpuBuffer] ${this.label}, buffer bytelength oversized, maximum bytelength: ${this.totalByteLength}`);
		try {
			this.context?.getGpuQueue().writeBuffer(this.buffer, e, n, 0);
		} catch (e) {
			console.error(`[updateGpuBuffer] ${this.label} error. message: ${e} `);
